...
(async () => {
  ...
  if (!consoleAddress) {
    ...
    window.location.href = "https://info.filament3d.org/L1/config.html?config=missingConfig";
    return;
  }
  ...
  if (!fwdidsuccess) {
    ...
    if (forwardId > lastForwardSuccess) {
      ...
      window.location.href = "https://info.filament3d.org/L1/config.html?config=forwardFailed";
      return;
    }
